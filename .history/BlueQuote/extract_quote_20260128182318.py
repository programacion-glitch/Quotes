...
def get_checkbox_group(data_map, mapping):
    ...
    for key, output_val in mapping.items():
        ...
        if val and (val == '/On' or val == '/Yes' or val == 'Yes' or 'S\xed' in val or 'Si' in val or val == 'On'):
            return output_val
    return None

def get_checkbox_bool(data_map, key):
    val = get_val(data_map, key)
    return val and (val == '/On' or val == '/Yes' or val == 'Yes' or 'S\xed' in val or 'Si' in val or val == 'On')
